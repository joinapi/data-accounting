...
class FixedAsset extends Model
{
    ...
    {
        return $this->belongsTo('\TechDataCalendar', 'calendar_id', 'calendar_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Enumeration', 'class_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Facility', 'located_at_facility_id', 'facility_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Product', 'instance_of_product_id', 'product_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\OrderHeader', 'acquire_order_id', 'order_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\AccommodationSpot', 'fixed_asset_id', 'fixed_asset_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\InventoryItem', 'fixed_asset_id', 'fixed_asset_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\CostComponent', 'fixed_asset_id', 'fixed_asset_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\Requirement', 'fixed_asset_id', 'fixed_asset_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Shipment\Delivery', 'fixed_asset_id', 'fixed_asset_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Workeffort\WorkEffortFixedAssetAssign', 'fixed_asset_id', 'fixed_asset_id');
    }
}
