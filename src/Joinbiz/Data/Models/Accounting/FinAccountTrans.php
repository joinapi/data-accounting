...
class FinAccountTrans extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\ReturnItemResponse', 'fin_account_trans_id', 'fin_account_trans_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\Party', 'performed_by_party_id', 'party_id');
    }
