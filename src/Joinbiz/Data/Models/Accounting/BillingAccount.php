...
class BillingAccount extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Uom', 'account_currency_uom_id', 'uom_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\OrderHeader', 'billing_account_id', 'billing_account_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\ReturnItemResponse', 'billing_account_id', 'billing_account_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\ReturnHeader', 'billing_account_id', 'billing_account_id');
    }
