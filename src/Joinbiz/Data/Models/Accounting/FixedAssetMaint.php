...
class FixedAssetMaint extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\OrderHeader', 'purchase_order_id', 'order_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Workeffort\WorkEffort', 'schedule_work_effort_id', 'work_effort_id');
    }
