...
class GlAccountType extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\ProductCategoryGlAccount', 'gl_account_type_id', 'gl_account_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\ProductGlAccount', 'gl_account_type_id', 'gl_account_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\CostComponentCalc', 'cost_gl_account_type_id', 'gl_account_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\CostComponentCalc', 'offsetting_gl_account_type_id', 'gl_account_type_id');
    }
