...
class CheckAccount extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['contact_mech_id', 'bank_name', 'routing_number', 'account_type', 'account_number', 'name_on_account', 'company_name_on_account', 'branch_code', 'last_updated_stamp', 'last_updated_tx_stamp', 'created_stamp', 'created_tx_stamp'];
