...
class PaymentMethod extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\ShoppingList', 'payment_method_id', 'payment_method_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\OrderPaymentPreference', 'payment_method_id', 'payment_method_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\ReturnHeader', 'payment_method_id', 'payment_method_id');
    }
