...
class PaymentMethodType extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\OrderPaymentPreference', 'payment_method_type_id', 'payment_method_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\ProductPaymentMethodType', 'payment_method_type_id', 'payment_method_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\ProductStoreVendorPayment', 'payment_method_type_id', 'payment_method_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\ProductStorePaymentSetting', 'payment_method_type_id', 'payment_method_type_id');
    }
