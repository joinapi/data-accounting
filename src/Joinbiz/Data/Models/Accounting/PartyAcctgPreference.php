...
class PartyAcctgPreference extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Uom', 'base_currency_uom_id', 'uom_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Enumeration', 'cogs_method_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\CustomMethod', 'invoice_seq_cust_meth_id', 'custom_method_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Enumeration', 'invoice_sequence_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\CustomMethod', 'order_seq_cust_meth_id', 'custom_method_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Enumeration', 'order_sequence_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\CustomMethod', 'quote_seq_cust_meth_id', 'custom_method_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Enumeration', 'quote_sequence_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Enumeration', 'tax_form_id', 'enum_id');
    }
