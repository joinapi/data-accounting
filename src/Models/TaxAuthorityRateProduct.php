...
class TaxAuthorityRateProduct extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\ProductCategory', 'product_category_id', 'product_category_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\ProductStore', 'product_store_id', 'product_store_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\ReturnAdjustment', 'tax_authority_rate_seq_id', 'tax_authority_rate_seq_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\OrderAdjustment', 'tax_authority_rate_seq_id', 'tax_authority_rate_seq_id');
    }
}
