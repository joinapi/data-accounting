 ...
 */
class VarianceReasonGlAccount extends Model
{
     ...
     * @var string
     */
    protected $table = 'variance_reason_gl_account';
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\VarianceReason', 'variance_reason_id', 'variance_reason_id');
    }
}
