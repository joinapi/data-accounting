...
class AcctgTransEntry extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\Uom', 'orig_currency_uom_id', 'uom_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\StatusItem', 'reconcile_status_id', 'status_id');
    }
