...
use Joinbiz\Data\Models\Party\ContactMechPurposeType;
...
class InvoiceContactMech extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\ContactMechPurposeType', 'contact_mech_purpose_type_id', 'contact_mech_purpose_type_id');
    }
