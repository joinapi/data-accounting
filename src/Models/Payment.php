...
class Payment extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\Uom', 'actual_currency_uom_id', 'uom_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\Party', 'party_id_from', 'party_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\OrderPaymentPreference', 'payment_preference_id', 'order_payment_preference_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\Party', 'party_id_to', 'party_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\RoleType', 'role_type_id_to', 'role_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\PerfReview', 'payment_id', 'payment_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\ReturnItemResponse', 'payment_id', 'payment_id');
    }
}
