...
class RateAmount extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\EmplPositionType', 'empl_position_type_id', 'empl_position_type_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\PeriodType', 'period_type_id', 'period_type_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\Uom', 'rate_currency_uom_id', 'uom_id');
    }
