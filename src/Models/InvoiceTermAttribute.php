 ...
 * @property InvoiceTerm $invoiceTerm
 */
class InvoiceTermAttribute extends Model
{
     ...
     * @var string
     */
    protected $table = 'invoice_term_attribute';
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\InvoiceTerm', 'invoice_term_id', 'invoice_term_id');
    }
}
