...
class FinAccount extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\OrderPaymentPreference', 'fin_account_id', 'fin_account_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\Party', 'owner_party_id', 'party_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\ReturnHeader', 'fin_account_id', 'fin_account_id');
    }
}
