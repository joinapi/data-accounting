...
class GiftCardFulfillment extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\Enumeration', 'type_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\SurveyResponse', 'survey_response_id', 'survey_response_id');
    }
}
