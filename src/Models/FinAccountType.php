...
class FinAccountType extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Accounting\Enumeration', 'replenish_enum_id', 'enum_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\ProductStoreFinActSetting', 'fin_account_type_id', 'fin_account_type_id');
    }
}
